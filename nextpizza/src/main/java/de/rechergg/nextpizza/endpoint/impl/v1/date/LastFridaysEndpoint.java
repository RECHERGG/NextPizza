...
public class LastFridaysEndpoint extends Endpoint {

    private static final String PATH = Endpoint.API_PATH + "last-fridays/";

    public LastFridaysEndpoint(@NotNull NextPizza nextPizza) {
    ...
    public void get(Context context) {
        ...
        JSONObject message = new JSONObject()
                ...
                .put("data", new JSONObject()
                        .put("fridays", nextPizza().pizzaManager().getLastFridaysInMillis().reversed()));
